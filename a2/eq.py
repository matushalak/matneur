...
def Q2_5_6(eps:float = 1e-3, mu:float = 2e-2):
    ...
    # ------------------------------------------------------------
    Ca_vals = np.linspace(0.0, 5, 501)     # slow‑variable parameter
    ...
    ax.plot(Ca_branch, n_branch, V_branch, lw=1.0, color='gold',
    ...
    # if V_eq:
    ax.scatter(Castar, n_inf(Vstar), Vstar, s=60, color='red', label='Full equilibria')
...
if __name__ == '__main__':
    # Q2.5
    # for eps in [3e-4, 1e-3, 1e-2, 1e-1, 0.5]:
    #     Q2_5_6(eps=eps)
